...
path = Path("misc_sprites_and_background")
...
for images in listdir(abs_path):
    if images == "background.png":
        bg_img = images
        print(abs_path)
        print(bg_img)  # Replace 'background.png' with the actual image file name

str_abs = str(abs_path)

background_image = pygame.image.load(str_abs+"/"+bg_img)  # Replace 'background.png' with the actual image file name
