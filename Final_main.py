...
def common_fish():
    ...
    # Load the background image
    bg_img = folder_search("common_fish_encyclopedia", "all_common_fish.png")
    background_image = pygame.image.load(bg_img)
    background_image = pygame.transform.scale(background_image, (WINDOW_WIDTH, WINDOW_HEIGHT))
...
def uncommon_fish():
    ...
    # Load the background image
    bg_img = folder_search("uncommon_fish_encyclopedia", "all_uncommon_fish.png")
    background_image = pygame.image.load(bg_img)
    background_image = pygame.transform.scale(background_image, (WINDOW_WIDTH, WINDOW_HEIGHT))
...
def rare_fish():
    ...
    # Load the background image
    bg_img = folder_search("rare_fish_encyclopedia", "all_rare_fish.png")
    background_image = pygame.image.load(bg_img)
    background_image = pygame.transform.scale(background_image, (WINDOW_WIDTH, WINDOW_HEIGHT))
...
def ultimate_fish():
    ...
    # Load the background image
    bg_img = folder_search("ultimate_fish_encyclopedia", "all_ultimate_fish.png")
    background_image = pygame.image.load(bg_img)
    background_image = pygame.transform.scale(background_image, (WINDOW_WIDTH, WINDOW_HEIGHT))
